...
import com.yb.part5_chapter05.databinding.ItemStationBinding
import com.yb.part5_chapter05.domain.Station
import com.yb.part5_chapter05.extension.dip
import com.yb.part5_chapter05.presentation.view.Badge
...
class StationsAdapter : RecyclerView.Adapter<StationsAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ItemStationBinding) :
        ...
        init {
            binding.stationNameTextView.setOnClickListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(ItemStationBinding.inflate(LayoutInflater.from(parent.context),
            parent,
            false))
