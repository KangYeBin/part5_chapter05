package com.yb.part5_chapter05.data.api.response.mapper

import com.yb.part5_chapter05.data.api.response.RealtimeArrival
...
fun RealtimeArrival.toArrivalInformation(): ArrivalInformation =
    ArrivalInformation(
        ...
        updatedAt = recptnDt
            ...
            ?.let { dateFormat.format(it) } ?: INVALID_FIELD
    )
